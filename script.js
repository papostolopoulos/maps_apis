...
metadataRequest.open('GET', 'https://api.tomtom.com/map/1/glyph/20.0.0-8/metadata.json?key=5Wg5wU3exfDgYYl9dbGfyJTr3NI57sAR');
...
setTimeout(function(){
    ...
    resourceRequest.open('GET', 'https://api.tomtom.com/map/1/style/20.0.0-8/basic_main.json?key=5Wg5wU3exfDgYYl9dbGfyJTr3NI57sAR');
...
setTimeout(function(){
    ...
    mergedRequest.open('GET', 'https://api.tomtom.com/map/1/style/20.0.0-8/basic_main.json?key=5Wg5wU3exfDgYYl9dbGfyJTr3NI57sAR');
